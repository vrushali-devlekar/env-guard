...
import { compareEnvs, parseEnvContent, serializeEnv } from '../src/utils/env-parser.js';
...
EMPTY_VAL=
    ...
    expect(entries.get('DATABASE_URL')?.value).toBe('postgres://user:pass@localhost:5432/db');
